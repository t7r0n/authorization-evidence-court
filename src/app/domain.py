...
LABEL = 'Prior Authorization Evidence Court'
FIXTURE = 'prior_auth_cases.jsonl'
ANALYSIS = 'prior_auth_analysis.json'
CSV_NAME = 'authorization_verdicts.csv'
DASHBOARD_TITLE = 'Policy Evidence Court'
...
SLUG = 'fairway-health-prior-auth-evidence-court'
